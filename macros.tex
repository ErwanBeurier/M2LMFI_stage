...
\newcommand{\minlist}[2]{\underset{#1}{\min}\left( #2 \right)}
\newcommand{\maxset}[1]{\max\left( \left\lbrace #1 \right\rbrace \right)}
\newcommand{\maxlist}[2]{\underset{#1}{\max}\left( #2 \right)}
...
\newcommand{\issu}{\espace

\textcolor{blue}{[\textit{Ce qui suit est extrait de mon T.I.P.E. de Spé sur la propriété d'universalité de $\zeta$.}]}

\espace}
\newcommand{\fin}{\espace
