	...
	\begin{appendices}
		...
		On peut enfin coder le test d'égalité. On rappelle que l'algorithme se trouve \hyperref[algo:A_RAM_fn_IF]{plus haut}.
		...
		\begin{algorithm}[H]
			...
			\caption{Fonction $\text{ACCESS}\left( \mu, \mu_1, \mu_2, \mu_3, \mu_4, \alpha, \beta, \pi_1, \pi_2, \pi'_1, \pi'_2\right)$. Algorithme \hyperref[algo:A_RAM_fn_ACCESS]{ci-dessus}. }
		\end{algorithm}
