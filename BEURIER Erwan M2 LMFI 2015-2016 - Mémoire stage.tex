...
\begin{document}
	...
	Ceci n'est qu'un brouillon de mon mémoire. Il a beau dépasser les 40 pages, il n'en est pas moins incomplet. Il est probablement plein de fautes de français et de textes \redtext{en rouge} voire \nepasoublier{encadrés en rouge}. C'est moi-même qui me signale des points que je ne dois pas oublier de rectifier ou d'ajouter.
	...
	\section{Des caractérisations de $P$}
		...
		\begin{definition}[Fonctions récursives à arguments normaux \cite{BellantoniCook1992}]
			...
			\nepasoublier{Décaler d'une tabulation}
		...
		\nepasoublier{Parler de la preuve.}
		...
		\nepasoublier{Résumé de l'article \cite{Leivant1995} de Leivant}
		...
		\begin{definition}[Degré d'imbrication de récurrences]
	...
	\label{sec:RAM_story}
		...
		\label{subsec:comparaison_RAMs}
			...
			Les démonstrations se trouvent dans \cite{Leivant1995} \nepasoublier{Il me faut une source pour la $\sigma$-RAM.}.
				...
				\nepasoublier{Code + algo de cette optimisation}
