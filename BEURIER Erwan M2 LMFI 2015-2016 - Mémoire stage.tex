...
\begin{document}
	...
	\nepasoublier{NE PAS OUBLIER}
	
	\begin{itemize}
		\item 	Sources pour Cobham et l'équivalence de $\textbf{P}$ (pour Turing) et $\textbf{P}$ (pour RAM).
	\end{itemize}
	...
	\section{Des caractérisations de $P$}
		...
		\label{sec:Cobham}
			...
			\begin{definition}[Récurrence bornée sur les notations]
			...
			%Conséquence : il existe une borne explicite pour chaque fonction de $\textbf{P}$. 
		...
		\subsection{Approche de Bellantoni et Cook}
			...
			Ensuite, on se place dans une algèbre de mots (tous les constructeurs de l'algèbre sont d'arité au plus $1$ ; typiquement, l'algèbre des mots binaires). \nepasoublier{Pourquoi les algèbres de mots !!}
			
			\begin{definition}[Composition \emph{safe}]
			...
			\begin{definition}[Récurrence \emph{safe}]
		...
		\label{subsec:Leivant}
			...
			\begin{definition}[Composition ramifiée]
			...
			\begin{definition}[Argument critique]
			...
			\begin{definition}[Récurrence ramifiée]
			...
			\label{subsubsec:sim_A_RAM_sigma_RAM}
				...
				\begin{proof}
					...
					\begin{algorithm}[H]
						...
						\caption{Fonction $\text{INSERT}\left( \mu, \mu_1, \mu_2, \mu_3, \mu_4, \alpha, \beta, \pi_1, \pi_2, \pi'_1, \pi'_2\right)$. Programme \hyperref[prog:A_RAM_fn_INSERT]{en annexe}. }
					\end{algorithm}
